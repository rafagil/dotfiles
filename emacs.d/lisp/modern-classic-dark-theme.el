;;; modern-classic-dark-theme.el --- Inspired by Sam Halliday's inspired IntelliJ Darcula theme

;; Copyright (C) 2015  Channing Walton

;; Author: Channing Walton <channingwalton@mac.com>
;; Author: Sam Halliday <Sam.Halliday@gmail.com> (because I copied it - Channing)
;; Keywords: faces
;; URL: TODO
...
(custom-theme-set-faces
 ...
 '(font-lock-type-face ((t (:foreground "#eaeaea" :inherit 'default))))
                                        ;for the names of user-defined data types.
 '(font-lock-constant-face ((t (:foreground "#eaeaea" :weight bold :inherit 'font-lock-variable-name-face))))
 ...
 '(escape-glyph ((((background dark)) (:foreground "#eaeaea")) (((type pc)) (:foreground "magenta")) (t (:foreground "brown"))))
 ...
 '(header-line ((t (:weight normal :slant normal :underline nil :box nil :inverse-video t :foreground "#a4a4a4" :inherit (mode-line)))))
 '(tooltip ((((class color)) (:inherit (variable-pitch) :foreground "black" :background "lightyellow")) (t (:inherit (variable-pitch)))))
 '(mode-line ((t (:weight normal :slant normal :underline nil :box nil :inverse-video t :foreground "#3c3f41" :background "#eaeaea"))))
 ...
 '(git-gutter:modified ((t (:foreground "#EAEAEA"))))
...
(provide-theme 'modern-classic-dark)

;;; modern-classic-dark-theme.el ends here
