(evil-define-key `normal scala-mode-map (kbd "s-n")    'ensime-search)
...
(evil-define-key `normal scala-mode-map (kbd "M-s-¬")  'ensime-format-source)
...
(evil-define-key `normal scala-mode-map (kbd "M-s-~")  'ensime-refactor-inline-local)
